...
from BrainGNN_Pytorch.net.brainmsgpassing import MyMessagePassing
from torch_geometric.utils import add_remaining_self_loops,softmax

from torch_geometric.typing import (OptTensor)

from BrainGNN_Pytorch.net.inits import uniform
...
#        uniform(self.in_channels, self.weight)
    ...
    def forward(self, x, edge_index, edge_weight=None, pseudo= None, size=None):
        ...
        # print("MyNNConv: in channels: " + str(self.in_channels) + " out channels: " + str(self.out_channels))
