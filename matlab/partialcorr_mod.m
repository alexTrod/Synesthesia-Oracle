% Original in https://osf.io/7gevx
...
datasetlist = {'MSMall_data_hcpmain'};
...
for idataset = 1:numel(datasetlist)
    ...
    Fnetmats_prep_all = [Fnetmats_prep_all; Fnetmats_prep]; 

end

save('parcor.mat', 'Pnetmats_icov_prep_all');
save('fullcor.mat', 'Fnetmats_prep_all');
